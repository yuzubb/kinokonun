...
(function() {
    ...
    //=========================================================================
    // 0. オートセーブを有効化
    //    本来はCommunity_Basicプラグインが担当する設定だが、
    //    そのプラグインがプラグイン一覧から外れていたため、
    //    オートセーブの発火条件(_autoSaveFileId)が一度も設定されず、
    //    マップ移動時の自動セーブが完全に無効化されていた。
    //    セーブファイル1番をオートセーブ専用スロットとして有効化する。
    //=========================================================================
    DataManager.setAutoSaveFileId(1);
